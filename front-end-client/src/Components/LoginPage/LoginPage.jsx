            ...
            <div class="bg-white shadow-lg rounded-lg w-[550px] h-96x p-0 ml-10 mb-20">
              ...
              <div class="w-full flex justify-center">
                {!currentUser && (
                  ...
                  >
                    Don't have an account? <span class="underline font-semibold">Sign Up</span>
                  </button>
                )}
              </div>
            </div>
