...
//   };
  ...
  const mappedMoodChoices = Object.entries(moodChoices).map(
    ([emoji, description], index) => {
      return (
        <div key={index}>
          <button
            value={emoji}
            class="text-center bg-transparent transition-transform transform-gpu hover:scale-105 text-6xl mt-2"
...
//           <div class="flex justify-center items-center p-3 mt-3">
//             <button
//               class="rounded-md flex justify-center font-semibold text-transparent bg-clip-text bg-gradient-to-r from-emerald-200 to-yellow-200 
//               hover:scale-110"
//               onClick={() => {
...
//           <div class="flex justify-center items-center p-3 mt-3 ">
//             <button
//               class="w-1/3 h-full text-sm py-0.25 bg-emerald-200 text-center rounded-md transition-colors duration-500 transform inline
//              hover:bg-yellow-200
//               hover:shadow-md
//               hover:scale-110"
//               onClick={() => {
